...
TEMPLATE_PATHS = {
    ...
    "information": f"{BASE_PATH}/Materials-stack4列.xlsx",
...
crystallize_TEMPLATE_PATHS = {
    ...
    "information":f"{crystallize_BASE_PATH}/Materials-stack4列.xlsx",
...
class ReactionProcessor:
    ...
    def modify_stack_table(self,transfer_records_12, transfer_records_24, transfer_records_2,BASE_PATH_1,BASE_PATH_2):
        ...
        if len(transfer_records_12) > 0:
            fill_cells.append('D2')
        len_24 = len(transfer_records_24)
        CELLS_ROW4 = ["D3", "D4", "D5"]  # 按顺序，对应每12长度一个单元格
        ...
        CELLS_ROW4 = ["D6", "D7", "D8","D9"]  # 按顺序，对应每12长度一个单元格
        ...
        if quenchingAgentData and internalStandardData:
            if 'D3'  not in fill_cells:
                fill_cells.append("D3")
        #萃取
        extractionData = self.post_data['experimentLog3']["extractionData"]
        if extractionData and 'D2' not in fill_cells:
            fill_cells.append("D2")
        ...
        for col_idx, (substance, volumes) in enumerate(self.reagent_plates_12_.items(), 1):
            ...
            for volume in volumes:
                ...
                while remaining_volume > 0:
                    ...
                    target_volume = (transfer_vol * 1000)/Decimal(hole_num)  if sub_volums else 0
                    if int(target_volume) <= 200:
                        pipette_location = 'A04'
                    else:
                        pipette_location = 'A05'
...
if __name__ == "__main__":
    ...
    # 结晶—溶析-正加
    data96 = {"id": "2e716c802e724341ae343bfbb713db76", "condition": {"experimentLog1": {"wellPlates": "96孔板1ml", "SubstratesTableList": [{"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057505677_2", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 1}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057505677_3", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 1}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057505677_4", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 1}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057505677_5", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 1}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057677429_1", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 2}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057677429_2", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 2}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057677429_3", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 2}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057677429_4", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 2}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057678397_5", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 3}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057678397_6", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 3}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057678397_7", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 3}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057678397_8", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 3}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057679981_9", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 4}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057679982_10", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 4}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057679982_11", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 4}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057679982_12", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 4}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057680351_13", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 5}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057680351_14", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 5}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057680351_15", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 5}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057680351_16", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 5}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057680718_17", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 6}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057680718_18", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 6}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057680718_19", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 6}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057680718_20", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 6}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057681047_21", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 7}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057681047_22", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 7}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057681047_23", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 7}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057681047_24", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 7}, {"limitReagents": False, "equivalent": "1.5", "smiles": "KOtBu", "substance": "试剂2,K2CO3", "type": "reagent", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057681413_25", "reactionQuality": "11.06", "cas": "", "molecularFormula": "C4H9KO", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "138.20", "reactionMoles": "0.08", "id": 8}, {"limitReagents": False, "smiles": "n-heptane", "substance": "溶剂1,DMF", "type": "solvent", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057681413_26", "cas": "", "molecularFormula": "C7H16", "singleCockAddVolume": "0.15", "reactionMoleConcentration": "", "solvent": "100.21", "id": 8}, {"limitReagents": True, "equivalent": "1.00", "smiles": "ClC1=NC=CC=N1", "substance": "ClC1=NC=CC=N1", "type": "sub", "liquidReagentConcentration": "固态", "reactionVolume": "0.25", "rowId": "row_1790057681413_27", "reactionQuality": "5.73", "cas": "", "molecularFormula": "C4H3ClN2", "singleCockAddVolume": "", "reactionMoleConcentration": "", "solvent": "114.53", "reactionMoles": "0.05", "id": 8}, {"limitReagents": False, "equivalent": "1.20", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "substance": "N2(CCNCC2)C3=CC=CC=C3", "type": "sub", "liquidReagentConcentration": "液体", "reactionVolume": "0.25", "rowId": "row_1790057681413_28", "reactionQuality": "9.73", "cas": "", "molecularFormula": "C10H14N2", "singleCockAddVolume": "0.1", "reactionMoleConcentration": "0.60", "solvent": "162.23", "reactionMoles": "0.06", "id": 8}], "MaterialsTableList": [{"type": "reagent", "substance": "试剂2,K2CO3", "smiles": "KOtBu", "solvent": "138.20", "molecularFormula": "C4H9KO", "theoreticalMoles": "0.64", "theoreticalQuality": "88.48", "theoreticalVolume": "0.00", "configurationMoles": "0.80", "cas": "", "id": 1, "configurationVolume": "0.00", "configurationQuality": "115.02", "concentration": ""}, {"type": "solvent", "substance": "溶剂1,DMF", "smiles": "n-heptane", "solvent": "100.21", "molecularFormula": "C7H16", "theoreticalMoles": "", "theoreticalQuality": "", "theoreticalVolume": "1.20", "configurationMoles": "", "cas": "", "id": 2, "configurationVolume": "5.00", "configurationQuality": "", "concentration": ""}, {"type": "sub", "substance": "ClC1=NC=CC=N1", "smiles": "ClC1=NC=CC=N1", "solvent": "114.53", "molecularFormula": "C4H3ClN2", "theoreticalMoles": "0.40", "theoreticalQuality": "45.84", "theoreticalVolume": "0.00", "configurationMoles": "0.53", "cas": "", "id": 3, "configurationVolume": "0.00", "configurationQuality": "59.59", "concentration": ""}, {"type": "sub", "substance": "N2(CCNCC2)C3=CC=CC=C3", "smiles": "N2(CCNCC2)C3=CC=CC=C3", "solvent": "162.23", "molecularFormula": "C10H14N2", "theoreticalMoles": "0.48", "theoreticalQuality": "77.84", "theoreticalVolume": "0.80", "configurationMoles": "0.64", "cas": "", "id": 4, "configurationVolume": "5.00", "configurationQuality": "101.19", "concentration": "0.60"}], "SynthesisMolReadList": [], "reactionParams": []}, "experimentLog2": {"ReactionConditions": {"environment": "1", "temperature": "100", "seal": "1", "time": "30", "speed": "900"}, "lightData": {"type": "1", "typeList": [{"label": "照射方式1", "value": "1"}, {"label": "照射方式2", "value": "2"}], "list": [{"status": "1", "WattageStart": "", "WattageType": "", "time": [{"start": "", "end": ""}]}, {"status": "1", "WattageStart": "", "WattageType": "", "time": [{"start": "", "end": ""}]}, {"status": "1", "WattageStart": "", "WattageType": "", "time": [{"start": "", "end": ""}]}, {"status": "1", "WattageStart": "", "WattageType": "", "time": [{"start": "", "end": ""}]}]}, "electricityData": {"type": "1", "list": []}, "gasData": {}}, "experimentLog3": {"quenchingAgentData": [], "productDilutionData": [{"name": "MeCN", "afterConcentration": "3.59 × 10⁻⁵", "procedure": {"diluent5": "10.00", "diluent4": "10.00", "diluent3": "190.00", "diluent2": "590.00", "diluent1": "190.00"}, "beforeConcentration": "0.30"}], "internalStandardData": [{"internalConcentration": "0.23", "name": "BENZANILIDE", "addVolume": "75", "molecularWeight": "197.23", "internalVolume": "25", "moles": "0.04", "internalQuality": "821.8"}], "filtrationData": [{"name": "0.22微米", "filterTime": "3"}], "extractionData": [{"name": "", "volume": "", "time": "", "times": "", "type": "1"}], "coolingTime": "10"}, "experimentLog4": {"instrumentName": "", "instrumentInstruments": [], "NMR": {"analyseArr": [{"name": "H NMR", "status": False}, {"name": "C NMR", "status": False}, {"name": "F NMR", "status": False}, {"name": "P NMR", "status": False}, {"name": "COSY", "status": False}, {"name": "HSQC", "status": False}, {"name": "HMBC", "status": False}, {"name": "NOESY", "status": False}], "solvent": {"name": "", "volume": "", "temperature": "", "frequency": ""}}, "MS": [], "LC": [], "LCMS": [], "GC": [], "UV": [{"wavelengthStart": "", "wavelengthEnd": "", "velocity": "", "width": "", "solvent": "", "concentration": ""}], "IR": [{"resolutionStart": "", "resolutionEnd": "", "scanNumber": "", "Wavenumber": ""}], "XRD": [{"startAngle": "", "endAngle": "", "stepLength": "", "scanSpeed": "", "scanDuration": "", "mode": ""}]}}}

    main('1564',data96['condition'],1)
    # main('1564',data_96,2)
